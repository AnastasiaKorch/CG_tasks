...
void init()
{
	...
	glClearColor(1, 1, 1 , 0); //белый фон
	...
	object->loadModel("stol.obj");
	object->loadTexture("box.png");
	object->setMaterial(material);
	object->setSize(0.05f);
	...
	object2->setPosition(Vector3D(0, 0.6f, 0));
	object2->setSize(0.5f);
	objects.push_back(object2);

	Mesh* object3 = new Mesh();;
	//object2->loadModel("teapot.obj");
	object3->loadModel("pla.obj");
	object3->loadTexture("carpet.png");
	object3->setMaterial(material);
	object3->setPosition(Vector3D(0, -0.6f, 0));
	object3->setSize(0.5f);
	objects.push_back(object3);

	Mesh* object4 = new Mesh();;
	//object2->loadModel("teapot.obj");
	object4->loadModel("stol2.obj");
	object4->loadTexture("marble.png");
	object4->setMaterial(material);
	object4->setPosition(Vector3D(0.5f, -0.6f, 1));
	object4->setSize(0.025f);
...
void keyboard(unsigned char key, int x, int y) {
	...
	case '2': spot_light.active = !spot_light.active;  break;
	case '3': directional_light.active = !directional_light.active;  break;
	}
}
