...
namespace Триангуляция_Делоне
{
	...
	public class Triad
	{
		...
		// координаты центра и квадрат радиуса описанной окружности
		...
		/// <summary>
		/// если текущее направление не по часовой стрелке, то меняем b и c
		/// </summary>
		...
		/// <summary>
		/// Возвращает истину, если точка p находится внутри окружности
		/// </summary>
	...
	class Triangulator
	{
		...
		private void Analyse(List<Vertex> suppliedPoints, Hull hull, List<Triad> triads, bool rejectDuplicatePoints, bool hullOnly)
		{
			if (suppliedPoints.Count < 3)
				throw new ArgumentException("Количество точек должно быть более 3-х!");
			...
			// Ищем точку, которая вместе с первыми двумя образует треугольник с минимальной описанной окружностью
